window.addEventListener('load', function() {
    ...
    var d = document;
    var cur = 0;
    var style = d.head.appendChild(d.createElement('style'));

    function go(n) {
        w.scrollTo(0, w.innerHeight * (cur = n) + 1);
    }

    function set() {
        style.innerHTML =
            '.slide {display:block;' + 'height:' + window.innerHeight + 'px;}';
    }
